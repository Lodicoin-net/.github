...
└─ docs/
   ...
   └─ media/       →  Assets, logos, press materials


🗺 ROADMAP
[ ] 🔹 Public API & documentation
[ ] 🔸 KOL verification & badges
[ ] 🪙 Reward & quest engine
[ ] 💬 Telegram + Discord adapters
[ ] ⚙️ SDKs: JS / TS / Python
[ ] 🛡️ Guardian program (community mods)
...
⚠️ DISCLAIMER
Lodicoin is a community-driven experimental initiative
built on Solana. Participation is voluntary and at your own risk.

Nothing here constitutes financial advice. Always DYOR before
engaging with any crypto project or asset.
